...
define('DB_HOST', 'sql312.iceiy.com');
define('DB_NAME', 'icei_40302817_woodconnect'); // Changed to match your domain
define('DB_USER', 'icei_40302817'); // Update with your actual database username
define('DB_PASS', 'Mahvellous1698'); // Update with your actual database password

// SIMPLE Base URL calculation
$protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? "https" : "http";
$host = $_SERVER['HTTP_HOST'];

// For domain deployment - use empty base path since it's at root of subdomain
$base_path = '';
